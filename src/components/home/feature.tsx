      ...
      <Container>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            We are a dynamic team of passionate individuals dedicated to delivering innovative solutions. Our expertise spans diverse fields, driving us to create impactful experiences for our clients. Join us on this journey of excellence.
            </Typography>
